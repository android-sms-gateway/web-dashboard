...
<div class="page">
	...
	{:else if view === "detail"}
		...
		{:else if detailError}
			<ErrorBanner message={detailError} onRetry={() => openDetail(requestedId)} onDismiss={() => { detailError = ""; requestedId = ""; }} />
	...
	{:else}
		...
		{:else if loadError}
			<ErrorBanner message={loadError} onRetry={loadMessages} onDismiss={() => loadError = ""} />
